...
const fr = {
  ...
  cart: {
    ...
    emptyHint: "Parcourez la collection et ajoutez vos décants.",
    continue: "Continuer mes achats",
    remove: "Retirer",
    quantity: "Quantité",
    ...
    delivery: "Livraison",
    free: "Offerte",
    deliveryHint: "Indiquez votre ville : la livraison peut changer.",
    missingForFree: "Plus que {amount} MAD pour la livraison offerte.",
    total: "Total (paiement à la livraison)",
    ...
    orderPlacedText:
      "Merci ! Nous vous contacterons au {phone} pour confirmer la livraison.",
  },
...
const ar: typeof fr = {
  ...
  cart: {
    ...
    empty: "سلتك فارغة",
    emptyHint: "تصفح المجموعة وأضف عطورك.",
    continue: "متابعة التسوق",
    remove: "حذف",
    quantity: "العدد",
    increase: "زيادة العدد",
    decrease: "إنقاص العدد",
    subtotal: "المجموع الفرعي",
    delivery: "التوصيل",
    free: "مجاني",
    deliveryHint: "أدخل مدينتك: ثمن التوصيل قد يتغير.",
    missingForFree: "يتبقى {amount} درهم للحصول على توصيل مجاني.",
    total: "المجموع (الدفع عند التسليم)",
    ...
    orderPlacedText:
      "شكراً لك! سنتصل بك على {phone} لتأكيد التوصيل.",
  },
